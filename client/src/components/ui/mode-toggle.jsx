        ...
        <TooltipProvider disableHoverableContent>
            <Tooltip delayDuration={100}>
                <TooltipTrigger asChild>
                    <Button
                        className="rounded-full w-8 h-8 bg-background text-foreground border-foreground"
                        variant="outline"
                        size="icon"
                ...
                <TooltipContent side="bottom" align="center" showArrow >Switch Theme</TooltipContent>
            </Tooltip>
        </TooltipProvider>
    );
}